<script lang="ts">
  ...
  onMount(() => {
    setTimeout(() => logoLoaded = true, 200);
    setTimeout(() => iconsVisible = true, 700);
  });
</script>
...
<section class="h-full flex flex-col items-center justify-center px-4">
  ...
  >
    <div class="flex items-center justify-between sm:justify-center sm:gap-12 md:gap-16">
      ...
      >
        <div class="w-12 h-12 sm:w-14 sm:h-14 bg-duda-verde/10 rounded-xl flex items-center justify-center group-hover:bg-duda-verde/20 transition-colors duration-300 backdrop-blur-sm">
          <svg class="w-6 h-6 sm:w-7 sm:h-7 text-duda-verde" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
          </svg>
        </div>
        <span class="text-[11px] sm:text-xs text-duda-cinza-claro group-hover:text-duda-verde transition-colors duration-300">Vídeos</span>
      </a>
      ...
      >
        ...
        <span class="text-[11px] sm:text-xs text-duda-cinza-claro group-hover:text-duda-verde transition-colors duration-300">Design</span>
      </a>
      ...
      >
        <div class="w-12 h-12 sm:w-14 sm:h-14 bg-duda-verde/10 rounded-xl flex items-center justify-center group-hover:bg-duda-verde/20 transition-colors duration-300 backdrop-blur-sm">
          <svg class="w-6 h-6 sm:w-7 sm:h-7 text-duda-verde" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span class="text-[11px] sm:text-xs text-duda-cinza-claro group-hover:text-duda-verde transition-colors duration-300">WhatsApp</span>
      </a>
      ...
      >
        ...
        <span class="text-[11px] sm:text-xs text-duda-cinza-claro group-hover:text-duda-verde transition-colors duration-300">Instagram</span>
      </a>
    </div>
  </div>
</section>
